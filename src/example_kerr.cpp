...
int main(int argc, char** argv )
{
	...
	int h = 40, w = 60;   // rendering window size
	...
	// Init raytracer
	Raytracer<KerrSchild, disk_model> rt(KS,photons,disk);
	...
	snum << "../output/Kerr_" << h<<"x"<< w << ".jpeg";
	std::cout<<" saving "<<snum.str()<<std::endl;
	cv::imwrite(snum.str(),I);
	
	snum.str("");
	snum << "../output/Kerr_smoothed_" << h<<"x"<< w  << ".jpeg";
	std::cout<<" saving "<<snum.str()<<std::endl;
